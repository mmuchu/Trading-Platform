"""FINAL_apply.py - One-shot patcher + verifier for v3.2.1 calibrations (39 checks)"""
...
print("=" * 50)
print(" FINAL PATCH v3.2.1 Calibrations")
print("=" * 50)
...
# FIX: Use full line match for stats property (not just the key)
ex = ex.replace(
...
if not syn(BASE + "\\services\\v3\\execution.py"):
    print("  ERROR: execution.py syntax broken! Check stats property.")
else:
